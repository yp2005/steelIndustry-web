...
public class RelationTable implements BaseSimplePojo {
    ...
    private String relationMasterTable; // 主表：master_card、project、device、employment_demand、main_post
    @Column(name = "relation_slave_table")
    private String relationSlaveTable; // 从表：worker_type、device_type、area_data、img_name(图片没有表,表示图片类型)
